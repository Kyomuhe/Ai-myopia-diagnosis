  ...
  const initialPatients = [
    {
      ...
      name: "Emma Johnson",
      age: 10,
      imagePath: "uploads/T0034.jpg",
      status: "Active",
      lastScan: "Mar 18, 2025",
      risk: "High",
    },
    {
      id: "10125",
      ...
      age: 8,
      status: "Active",
      imagePath: "uploads/T0043.jpg",
      lastScan: "Mar 15, 2025",
      risk: "Low",
    },
    {
      id: "10126",
      ...
      age: 12,
      status: "Active",
      imagePath: "uploads/T0277.jpg",
      lastScan: "Mar 10, 2025",
      risk: "Medium",
    },
    {
      id: "10127",
      ...
      age: 9,
      status: "Inactive",
      imagePath: "uploads/T0191.jpg",
      lastScan: "Feb 28, 2025",
      risk: "High",
    },
    {
      id: "10128",
      ...
      age: 11,
      status: "Active",
      imagePath: "uploads/T0386.jpg",
      lastScan: "Feb 25, 2025",
      risk: "Low",
    },
  ];
        ...
        patients.map(async (patient) => {
          try {
            const res = await axios.post(
              "http://localhost:5000/detect_severity",
              {
                image_path: patient.imagePath,
              }
            );
            return { ...patient, risk: res.data.risk };
          } catch (err) {
            console.error(`Error for patient ${patient.id}:`, err);
            return { ...patient, risk: "Unknown" };
          }
        })
      );
