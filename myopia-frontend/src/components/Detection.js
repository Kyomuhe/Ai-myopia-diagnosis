            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRefraction({ ...refraction, right: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRefraction({ ...refraction, left: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setVisualAcuity({ ...visualAcuity, right: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setVisualAcuity({ ...visualAcuity, left: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {refraction.right} / {refraction.left}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-500">Visual Acuity (OD/OS):</p>
                      <p className="font-medium">
                        {visualAcuity.right} / {visualAcuity.left}
                      </p>
                    </div>
                  </div>
                </div>
